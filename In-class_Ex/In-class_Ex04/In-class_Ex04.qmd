...
## 6 Geographically Weighted Summary Statistics (GSWW) with Adaptive Bandwidth
...
### 6.3 Computing Geographically Weighted Summary Statistics
...
::: callout-note
gwss support five kernel methods, namely gaussian, exponential, bisquare, tricube, and boxcar.
:::
...
### 6.4 Visualising geographically weighted summary statistics
