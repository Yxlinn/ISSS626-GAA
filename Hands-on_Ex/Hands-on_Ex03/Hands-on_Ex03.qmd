...
[STIKhat()](https://cran.r-project.org/web/packages/stpp/refman/stpp.html#STIKhat) from **stpp** is used to compute the space-time inhomogeneous K-function. The result can be visualised using `plotK()`.
